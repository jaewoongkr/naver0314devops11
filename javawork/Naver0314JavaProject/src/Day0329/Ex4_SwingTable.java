...
public class Ex4_SwingTable extends JFrame{
	...
	public Ex4_SwingTable(String title) {
		...
		this.getContentPane().setBackground(new Color(190, 100, 90));//배경색 변경
	...
	public void initDesign()
	{
		...
		String [][]data= {
				{"이영자","32세","B","010-9999-9999","서울"},
				{"강호동","45세","A","010-8888-8888","부산"},
				{"유재석","29세","O","010-4444-4555","제주도"},
				{"제니","23세","AB","010-2323-2323","뉴욕"},
		};
		...
		//프레임의 센터에 추가
		this.add("Center",new JScrollPane(table)); //테이블도 스크롤바가 생겨야한다(제목포함)
		//메세지 라벨을 South 에 추가
