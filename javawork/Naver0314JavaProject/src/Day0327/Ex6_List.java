...
public class Ex6_List {
	...
	public static void main(String[] args) {
		...
		System.out.println("list1의 할당된 갯수 : "+((Vector<String>)list1).capacity());//capacity 는 오버라이드 메서드가 아니고 Vecter가 갖고 있는 메서드임

		System.out.println("list2 데이타 갯수:"+list2.size());
		System.out.println("list3의 할당된 갯수 : "+((Vector<String>)list2).capacity());//capacity 는 오버라이드 메서드가 아니고 Vecter가 갖고 있는 메서드임
