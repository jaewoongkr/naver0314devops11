...
public class Ex4_SwingButton extends JFrame{
	...
	public Ex4_SwingButton(String title) {
		...
		this.getContentPane().setBackground(new Color(188, 50, 50));//배경색 변경
		...
		for(int i=0;i<btnArray.length;i++)
		{
			...
			btnArray[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					System.out.println(ob.getText());//초록색(새로나온 겟텍스트를 쓰는게 좋음)
	...
	class Button2Event implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) {
			// TODO Auto-generated method stub
			JOptionPane.showMessageDialog(Ex4_SwingButton.this, "버튼 2 을 눌렀어요");
		}
	}
