...
public class Ex8_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(str2.equals(str3));//false : 대소문자가 다름
		...
		System.out.println(str1.endsWith("day"));//str1이 Day 로 끝날경우 true : false
		System.out.println(str1.toLowerCase().endsWith("day"));//str1을 소문자로 변환 후 day 로 끝나는지 비교 : true
		...
		System.out.println(str1.replace("Nice", "Good"));//Have a Nice Day
		...
		//분리된 토큰값 출력
		while(st.hasMoreElements())//더이상 토큰이 없을경우 false가 되면서 while문을 빠져나간다
		{
