...
public class Ex5_SevesChat extends JFrame implements Runnable{
	JTextArea area;
	Vector<ClientMember> list=new Vector<Ex5_SevesChat.ClientMember>();
	ServerSocket serverSocket;
	
	public Ex5_SevesChat(String title) {
		// TODO Auto-generated constructor
		super(title);
		this.setLocation(100, 100);//시작위치
		this.setSize(500, 500);//창크기
		this.getContentPane().setBackground(new Color(100, 200, 50));//배경색 변경
	...
	public static void main(String[] args) {
		...
		Ex5_SevesChat a =new Ex5_SevesChat("채팅서버");
